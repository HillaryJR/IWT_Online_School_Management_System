...
<html>
    ...
    <head>
		...
		<link rel="stylesheet" href="../css/editEvents.css"></link>
    ...
    <body>
		...
		<center>
		<div id="mainD">
			<form method="POST" action="subEventEdit.php">
				<table id="mainT">
					<tr>
						<th>Event ID</th>
					...
					<tr>
						<th>Event Name</th>
						<td><input type="text" id="ename" name="ename" value=<?php echo $name ?>></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" id="btn"><button id="update" type="submit">Update</button></td>
					</tr>
